...
export default function PromotionImpactChart({ selectedYear }: Props) {
  ...
  if (chartData.error) return (
    <div className="w-full p-8 bg-white rounded-2xl shadow-sm border border-red-200 flex items-center justify-center h-[600px]">
      <span className="text-red-500 font-medium">Lỗi Backend: {chartData.error}</span>
    </div>
  );
