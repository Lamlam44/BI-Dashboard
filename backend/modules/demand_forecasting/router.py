"""
FastAPI router for Demand Forecasting.
...
from modules.demand_forecasting.data.feature_engineering import (
    create_all_features,
    prepare_model_data,
    get_feature_columns
)
from modules.demand_forecasting.models.forecasting_model import DemandForecastingModel
from modules.demand_forecasting import config
from modules.demand_forecasting.batch_train import train_global_model
...
async def refresh_ai_data():
    ...
    try:
        ...
        return {"status": "success", "message": "Tiáº¿n trÃ¬nh Ä‘á»“ng bá»™ vÃ  Train láº¡i MÃ´ hÃ¬nh AI thÃ nh cÃ´ng. ÄÃ£ ghi Ä‘Ã¨ file .pkl."}
...
@router.get("/forecast-latest/{product_id}")
